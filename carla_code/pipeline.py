            ...
            if not frame % frame_step:
                ...
                pos_vector=np.array([[
                   measurements.player_measurements.transform.location.x],
                    ...
                    [measurements.player_measurements.transform.location.z],[1.0]])
                carla_utils_obj = segmentation.carla_utils(intrinsic,camera_to_car_transform,world_transform)
                ...
                depth=scale*1000
                pos2d=np.array([(WINDOW_WIDTH-get_2d_point[0])*depth,(WINDOW_HEIGHT-get_2d_point[1])*depth,depth])
